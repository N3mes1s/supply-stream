...
add_module!(modules, "crate", crate_mod, "crate_mod.Crate", Some("crate_mod"), Some(crate_mod::__main__ as MainFn));
...
#[cfg(feature = "npm-module")]
add_module!(modules, "npm", npm, "npm.Npm", Some("npm"), Some(npm::__main__ as MainFn));
#[cfg(feature = "pe-module")]
add_module!(modules, "pe", pe, "pe.PE", Some("pe"), Some(pe::__main__ as MainFn));
#[cfg(feature = "pypi-module")]
add_module!(modules, "pypi", pypi, "pypi.Pypi", Some("pypi"), Some(pypi::__main__ as MainFn));
