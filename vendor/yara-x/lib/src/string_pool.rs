    ...
    T: From<u32> + Into<u32>,
{
    ...
    pub fn new() -> Self {
        Self {
            pool: intaglio::bytes::SymbolTable::with_hasher(HashBuilder::default()),
            size: 0,
            phantom: Default::default(),
        }
    }
...
mod test {
    ...
    fn string_pool_serde() {
        ...
        let serialized = bincode::serde::encode_to_vec(&pool, bincode::config::standard()).unwrap();
