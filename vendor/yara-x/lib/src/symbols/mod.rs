...
mod tests {
    ...
    fn message_lookup() {
        ...
        let test = Struct::from_proto_descriptor_and_msg(&TestProto2::descriptor(), None, true);
    ...
    fn message_dyn_lookup() {
        ...
        let structure =
            Struct::from_proto_descriptor_and_msg(&descriptor, Some(message.as_ref()), true);
        ...
        assert_eq!(structure.lookup("int32_one").unwrap().as_integer(), Some(1));
