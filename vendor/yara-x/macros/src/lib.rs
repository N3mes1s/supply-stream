...
pub fn wasm_export(args: TokenStream, input: TokenStream) -> TokenStream {
    ...
    wasm_export::impl_wasm_export_macro(args, parse_macro_input!(input as ItemFn))
        .unwrap_or_else(Error::into_compile_error)
        .into()
}
...
pub fn module_export(args: TokenStream, input: TokenStream) -> TokenStream {
    ...
    module_export::impl_module_export_macro(args, parse_macro_input!(input as ItemFn))
        .unwrap_or_else(Error::into_compile_error)
        .into()
}
