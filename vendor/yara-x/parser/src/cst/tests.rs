...
#[test]
fn cst_1() {
    let cst: CST = Parser::new(b"rule test { condition: true }")
        .try_into()
        .unwrap();
...
fn cst_3() {
    ...
    let condition_blk = cst.root().first_child().unwrap().first_child().unwrap();
...
fn cst_6() {
    ...
    */
    ...
    assert_eq!(
        root_node
            .token_at_position::<Utf32, _>((0, 11))
            .unwrap()
            .kind(),
        SyntaxKind::NEWLINE
    );
    ...
    assert_eq!(
        root_node
            .token_at_position::<Utf32, _>((2, 20))
            .unwrap()
            .kind(),
        SyntaxKind::COMMENT
    );
    ...
    assert_eq!(
        root_node
            .token_at_position::<Utf32, _>((6, 16))
            .unwrap()
            .kind(),
        SyntaxKind::FALSE_KW
    );
    ...
    assert_eq!(
        root_node
            .token_at_position::<Utf16, _>((6, 17))
            .unwrap()
            .kind(),
        SyntaxKind::FALSE_KW
    );
    ...
    assert_eq!(
        root_node
            .token_at_position::<Utf32, _>((6, 20))
            .unwrap()
            .kind(),
        SyntaxKind::FALSE_KW
    );
    ...
    assert_eq!(
        root_node
            .token_at_position::<Utf16, _>((6, 21))
            .unwrap()
            .kind(),
        SyntaxKind::FALSE_KW
    );
    ...
    assert_eq!(
        root_node
            .token_at_position::<Utf32, _>((6, 21))
            .unwrap()
            .kind(),
        SyntaxKind::NEWLINE
    );
    ...
    assert_eq!(
        root_node
            .token_at_position::<Utf16, _>((6, 22))
            .unwrap()
            .kind(),
        SyntaxKind::NEWLINE
    );
