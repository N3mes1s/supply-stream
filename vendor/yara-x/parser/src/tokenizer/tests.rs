...
fn identifiers() {
    let mut lexer =
        super::Tokenizer::new("foo _bar baz0 qux_1 $ $_ $foo @foo #foo !foo _123".as_bytes());
    ...
    assert_eq!(
        lexer.next_token(),
        Some(Token::PATTERN_OFFSET(Span(30..34)))
    );
    ...
    assert_eq!(
        lexer.next_token(),
        Some(Token::PATTERN_LENGTH(Span(40..44)))
    );
...
fn integer_literals() {
    ...
    let mut lexer = super::Tokenizer::new(r#"1_0 0x1_0 0o1_0 1__0 0x1__0 0o1__0"#.as_bytes());
...
#[test]
fn float_literals() {
    let mut lexer = super::Tokenizer::new(r#"3.14 10.0 1.0 1_0.0_1 1__0.0__1"#.as_bytes());
...
fn regexps() {
    ...
    let mut lexer = super::Tokenizer::new(r#"/foobar/i /(foo|bar)/s"#.as_bytes());
